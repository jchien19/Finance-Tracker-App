...
//     return (
//         <div className='absolute drop-shadow-sm top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white w-1/3 main-container inner content rounded-lg' 
//              onSubmit={handleSubmit()}>
...
//                   required 
//               />
//               <button className="sessionButton rounded w-3/4">Login</button>
//           </form>
